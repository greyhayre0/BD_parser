...
async def migrate_df_db(df):
    '''Асинхронное добавление данных в PostgreSQL'''
    conn = await asyncpg.connect(user='ваш_пользователь', password='ваш_пароль',
                                 database='ваша_база', host='localhost')
...
# times 155.19 sec асинхронно sqllite3
# elements 150693 асинхронно sqllite3

# times 124.80 sec асинхронно postgreSQL
# elements 150693 асинхронно postgreSQL